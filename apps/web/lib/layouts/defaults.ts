...
export const DEFAULT_HOME_LAYOUT: PageLayout = {
  ...
  blocks: [
    ...
    fullRow('categories', 'categories', 4, { title: 'Shop by Category', subtitle: 'Browse our wide selection of products', limit: 8 }),
    ...
    fullRow('dealCountdown', 'dealCountdown', 7, {
    ...
    fullRow('testimonials', 'testimonials', 10, {
      title: 'Loved by our customers',
      items: [
        { name: 'Sarah M.', role: 'Verified buyer', rating: 5, text: 'Ordered on a Monday and it arrived Wednesday.' },
        { name: 'Daniel K.', role: 'Verified buyer', rating: 5, text: 'Support answered within the hour.' },
        { name: 'Ava R.', role: 'Verified buyer', rating: 4, text: 'Great prices. This is my third order this year.' },
      ],
    }),
    fullRow('gallery', 'gallery', 11, { title: 'From our shop', layout: 'masonry', columns: 4 }),
