...
export default function AdminUsersPage() {
  ...
  const fetchUsers = async () => {
    try {
      ...
      // Use fetch directly since api doesn't have getUsers
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          <thead>
            <tr style={{ backgroundColor: '#f9f9f9', borderBottom: '1px solid #e5e5e5' }}>
              ...
              <th style={{ padding: '12px 16px', textAlign: 'center', fontSize: '12px', fontWeight: 600, color: '#666' }}>Reviews</th>
                ...
                <td style={{ padding: '16px' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    ...
                    <div>
                      ...
                      <p style={{ fontSize: '12px', color: '#666' }}>ID: {user.id?.slice(0, 8)}...</p>
                    </div>
                  </div>
                </td>
