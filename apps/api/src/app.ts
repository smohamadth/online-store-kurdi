...
import bundleRoutes from './modules/marketing/bundle.routes';
...
import themeRegistryRoutes from './modules/themeRegistry/themeRegistry.routes';
...
app.use('/api/affiliates', affiliateAdminRoutes);
